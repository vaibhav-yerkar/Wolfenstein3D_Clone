...
DirectionalLight PhongShader::m_directionalLight =
    DirectionalLight(BaseLight(Vector3f(0, 0, 0), 0), Vector3f(0, 0, 0));
...
void PhongShader::updateUniforms(const Matrix4f& worldMatrix,
                                 ...
                                 Material& material)
{
  ...
  setUniformf("directionalLight.base.intensity",
              m_directionalLight.base.intensity);
  ...
  for (int i = 0; i < m_numPointLights; i++)
  {
    ...
    setUniformf(pointLightName + ".base.intensity",
                m_pointLights[i].base.intensity);
    setUniformf(pointLightName + ".atten.constant",
                m_pointLights[i].atten.constant);
    setUniformf(pointLightName + ".atten.linear",
                m_pointLights[i].atten.linear);
    setUniformf(pointLightName + ".atten.exponent",
                m_pointLights[i].atten.exponent);
  ...
  for (int i = 0; i < m_numSpotLights; i++)
  {
    ...
    setUniform(spotLightName + ".pointLight.base.color",
               m_spotLights[i].pointLight.base.color);
    setUniformf(spotLightName + ".pointLight.base.intensity",
                m_spotLights[i].pointLight.base.intensity);
    setUniformf(spotLightName + ".pointLight.atten.constant",
                m_spotLights[i].pointLight.atten.constant);
    setUniformf(spotLightName + ".pointLight.atten.linear",
                m_spotLights[i].pointLight.atten.linear);
    setUniformf(spotLightName + ".pointLight.atten.exponent",
                m_spotLights[i].pointLight.atten.exponent);
    setUniform(spotLightName + ".pointLight.position",
               m_spotLights[i].pointLight.position);
    setUniformf(spotLightName + ".pointLight.range",
                m_spotLights[i].pointLight.range);
